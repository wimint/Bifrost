...
# Read the CSV file
df = pd.read_csv('january_2025_dhukbb53639xggxe5eucentral1.csv')
...
df.to_csv('output_ukbb53639_jan.csv', index=False)

print("Conversion complete. The updated file is saved as 'output_ukbb53639_jan.csv'.")

# Read the 'output_ukbb53639_2.csv' file
output_df = pd.read_csv('output_ukbb53639_jan.csv')
...
# Save the updated DataFrame to a new CSV file
output_df.to_csv('output_ukbb53639_with_usernames_jan.csv', index=False)

print("Conversion complete. The updated file is saved as 'output_ukbb53639_with_usernames_jan.csv',")
